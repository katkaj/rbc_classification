...
'''
dataset = libs_dataset.CellsDataset(training_files, training_labels, testing_files, testing_labels, window_size = 128, classes_count = 2, augmentations_count=100, cols = [1,2,3,7,8,9,10,11,12,19,20,21,22,23,24])
