...
'''
dataset = libs_dataset.CellsDataset(training_files, training_labels, testing_files, testing_labels, window_size = 64, classes_count = 2, augmentations_count=100, cols = [7,8,10,11,13,14,16,17])
