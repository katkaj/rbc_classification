...
class CellsDataset:
    ...
    '''
    def __init__(self, training_files, training_labels, testing_files, testing_labels, classes_count, window_size = 1024, cols = [14, 15, 17, 18, 20, 21, 23, 24], augmentations_count = 32):
