...
'''
dataset = libs_dataset.CellsDataset(training_files, training_labels, testing_files, testing_labels, window_size = 128, classes_count = 2, augmentations_count=100, cols = [1, 2, 3])
